...
class MapHelper {
  ...
  static Future<BitmapDescriptor> getMarkerImageFromUrl(
    ...
    //Uint8List markerImageBytes = AssetImage('assets/green marker.png').bundle .readAsBytes();

    cnt++;
    if (cnt == 1)
      return BitmapDescriptor.fromAssetImage(
          ImageConfiguration.empty, 'assets/green.png');
    if (cnt == 2)
      return BitmapDescriptor.fromAssetImage(
          ImageConfiguration.empty, 'assets/red.png');
    if (cnt == 3) {
      cnt = 0;
      return BitmapDescriptor.fromAssetImage(
          ImageConfiguration.empty, 'assets/yellow.png');
    }
  }
